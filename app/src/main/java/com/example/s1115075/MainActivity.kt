...
import com.example.s1115075.ui.theme.s1115075Theme
...
fun Animation(){
    ...
    Column {
        ...
        AnimatedVisibility(
            ...
            Image(
                painter = painterResource(id = R.drawable.martha),
...
fun twobutton(){
    ...
    var h1 by remember { mutableStateOf("「台中市愛心家園」經市政府公開評選後，委託瑪利亞基金會經營管理，於91年啟用，整棟建築物有四個樓層，目前開辦就醫、就養、就學、
        var h2 by remember { mutableStateOf("長按以下圖片，可以觀看愛心家園地圖") }
        Column {
            Row {
                Button(
                    onClick = {
                        h1 = "「台中市愛心家園」經市政府公開評選後，委託瑪利亞基金會經營管理，於91年啟用，整棟建築物有四個樓層，目前開辦就醫、就養、就學、就業四大領域的
                ...
                Button(
                    onClick = {
                        h1 = "「瑪利亞學園」提供重度以及極重度多重障礙者日間照顧服務，以健康照護為基礎，支持生活多面向參與及學習概念，輔助發展重度身心障礙者自我概念為最
